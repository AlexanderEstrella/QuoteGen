const quotes = [
    ...
    {
        quote: "Hard work and education will take you farther than any government program can ever promise.",
        author: "Mia Love"
    },
    {
    ...
    {
        quote: "Work hard and believe in yourself even when nobody else believes in you.",
...
function gen() {
    const arrayIndex = Math.floor(Math.random() * 13) + 1;
